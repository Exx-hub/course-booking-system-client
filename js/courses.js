                  ...
                  <div class='card-footer'>
                    <div class="row">
                        <div class="col-sm-12 col-md-4 mb-1">
                          <a href="./view_course.html?id=${course._id}" class="btn btn-block siteButton">View</a>
                        </div>
                        <div id="editBtn" class="col-sm-12 col-md-4 mb-1">
                          <a href="./edit_course.html?id=${course._id}" class="btn btn-outline-secondary btn-block btn-course">Edit</a>
                        </div>
                        <div id="deleteBtn" class="col-sm-12 col-md-4 mb-1">
